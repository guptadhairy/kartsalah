  ...
  return (
    <Router>
      <Routes>
        ...
        <Route
          path="/behaviouralquestions"
          element={<BehaviouralQuestions />}
        />
        <Route
          path="/resumeverification"
          element={<ResumeVerificationPage />}
        />
        <Route path="/admin" element={<Admin />} />
        <Route path="/teamsstudents" element ={<TeamsStudents />} />
      </Routes>
    </Router>
  );
}
