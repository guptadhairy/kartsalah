  ...
  return (
    <div className="flex flex-col md:flex-row w-full h-full p-6 relative">
      ...
      <div className="flex-1 p-6">
        <div className="sm:text-5xl text-3xl font-bold text-blue-600 mb-4 flex flex-col font-mono">
          <span className="text-black">Generate Cover</span>
          <span> Letter</span>
        </div>
        <p className="text-lg text-gray-600 mb-6">
          Craft tailored cover letters effortlessly with AI, perfectly aligned
          with your job application and resume.
        </p>
